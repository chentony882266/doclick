    ...
    return (
        <div className="h-screen w-full flex flex-col md:flex-row overflow-hidden">
            ...
            <div className="absolute top-6 left-6 z-50 pointer-events-none">
                <div className="bg-white/90 backdrop-blur px-4 py-2 rounded shadow-sm">
                    <span className="font-bold text-gray-900 text-lg tracking-wider">愜易居</span>
                    <span className="text-gray-500 text-xs ml-2">Workforce OS</span>
                </div>
            </div>
        </div>
    );
